...
public class GenerateBrokerIdException extends RuntimeException {
    ...
    public GenerateBrokerIdException(String message, Throwable throwable) {
        super(message, throwable);
    }

    public GenerateBrokerIdException(Throwable throwable) {
        super(null, throwable);
    }

    public GenerateBrokerIdException(String message) {
        super(message, null);
    }
}
