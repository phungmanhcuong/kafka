...
public class OffsetsOutOfOrderException extends RuntimeException {
    public OffsetsOutOfOrderException() {
        super(null, null);
    }

    public OffsetsOutOfOrderException(String message, Throwable throwable) {
        super(message, throwable);
    }

    public OffsetsOutOfOrderException(Throwable throwable) {
